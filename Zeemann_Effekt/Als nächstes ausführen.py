...
deltaLambdaDblau=funktionen.wellenlaengenverschiebung(DeltaSblau, deltaSblau, 26.95e-12)
mittelwertBlau=funktionen.mittelwert(deltaLambdaDblau,8)
deltaLambdaDblau2=funktionen.wellenlaengenverschiebung(DeltaSblau2, deltaSblau2, 26.95e-12)
mittelwertBlau2=funktionen.mittelwert(deltaLambdaDblau2,6)
deltaLambdaDrot=funktionen.wellenlaengenverschiebung(DeltaSrot, deltaSrot, 48.91e-12)
mittelwertRot=funktionen.mittelwert(deltaLambdaDrot,100)
...
grot=funktionen.landefaktoren(mittelwertRot, 0.4521, 648.8e-9)
gblau1=funktionen.landefaktoren(mittelwertBlau, 0.347, 480e-9)
gblau2=funktionen.landefaktoren(mittelwertBlau2, 0.4521, 480e-9)
