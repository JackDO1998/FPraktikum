...
\begin{table}
    ...
    \begin{figure}
      ...
      \input{daten/bearbeitet/blau mit magnet 0 (2)/Daten.tex}
      \input{daten/bearbeitet/blau mit magnet 90 (2)/Daten.tex}
      \input{daten/bearbeitet/blau ohne magnet 0 (2)/Daten.tex}
      \input{daten/bearbeitet/blau ohne magnet 90 (2)/Daten.tex}
      \input{daten/bearbeitet/rot mit magnet 0 (2)/Daten.tex}
      \input{daten/bearbeitet/rot mit magnet 90 (2)/Daten.tex}
      \input{daten/bearbeitet/rot ohne magnet 0 (2)/Daten.tex}
      \input{daten/bearbeitet/rot ohne magnet 90 (2)/Daten.tex}