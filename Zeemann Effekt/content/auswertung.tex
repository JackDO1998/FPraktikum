...
\label{sec:rot}
Zunächst wird der normale Zeemaneffekt an der roten $\sigma$-Linie der Cadmiumdampflampe vermessen.
In \autoref{fig:rot0} sind die Aufnahmen der Lummer-Gehrke-Platte zu sehen. Dabei stand der polarisationsfilter
...
dargestellt. Die Wellenlängenverschiebung berechnet sic über:

\begin{equation}
  \delta \lambda =\frac{\delta s}{2\delta S}\Delta \lambda_D
\end{equation}
\input{content/tabellen/Tab Rot.tex}
...
Aufbaus so eingestellt das nun die blaue Spektrallienie auf die Lummer-Gehrke-Platte trifft.
Anschließend wird der Polarisationsfilter auf $\phi=\SI[]{90}[]{\degree}$ eingestellt.
Dann kann analog zu \autoref{sec:rot} vorgegeangen werden. Die dabei errechenten Werte
...
\begin{figure}
  ...
  \label{fig:blau90}
\end{figure}
\input{content/tabellen/Tab Blau2.tex}
...
\begin{figure}
  ...
  \label{fig:blau0}
\end{figure}
\input{content/tabellen/Tab Blau.tex}
...
\FloatBarrier
  ...
  \input{content/tabellen/Plots.tex}
